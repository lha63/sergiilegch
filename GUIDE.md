...
1. **"Хэсгийн ахлагч / Эцэг эх"** сонгоно → **4 оронтой код** үүснэ
2. Кодоо хүүхдэд өгнө ("Код өгөх" товчоор хуваалцаж болно)
3. Хүүхэд холбогдмогц газрын зураг дээр **амьд харагдана** — байршил, батерей, төлөв
4. Хүүхэд SOS дарвал **бүтэн дэлгэцээр улаан анхааруулга + дуу + чичиргээ** ирнэ → "Хүлээн авлаа" дарж шийдвэрлэнэ
...
1. **"Хүүхэд"** сонгоно → ахлагчаас авсан **кодоо оруулна**
2. **"Байршил хуваалцаж эхлэх"** → ахлагч таныг хянаж эхэлнэ
...
1. Энгийн цонхоор сайт нээ → нэр → **Хэсгийн ахлагч** → код гарна
2. Нэвтрэхгүй (incognito) цонхоор сайт нээ → нэр → **Хүүхэд** → кодыг оруул
3. Хүүхэд "Байршил хуваалцах" → ахлагчийн зураг дээр цэг гарна; **SOS** → ахлагчид шууд дохио

**2 утсаар бодит тест:**
1. 2 утсанд сайтыг нээж "Add to Home screen"
2. Дээрхтэй адил ахлагч/хүүхэд болж холбогдоно
